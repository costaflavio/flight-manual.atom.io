...
To clone a repository, run the `GitHub: Clone` command (in GitHub). In the dialog paste a URL of a repository and click "Clone". A new project will get added to the Tree View.
